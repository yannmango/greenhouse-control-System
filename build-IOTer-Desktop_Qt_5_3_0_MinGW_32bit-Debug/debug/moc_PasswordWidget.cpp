...
#include "../../ten_score/PasswordWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PasswordWidget_t, stringdata) + ofs \
...
const QMetaObject PasswordWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PasswordWidget.data,
      qt_meta_data_PasswordWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PasswordWidget.stringdata))
        return static_cast<void*>(const_cast< PasswordWidget*>(this));
